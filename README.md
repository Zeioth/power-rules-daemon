...
- IDEA: Maybe it would be a good idea to trigger state change: When the daemon is started. At the end of `pause_on_manual_change` (I could swear we are already doing this one, but let's make sure).
